    ...
    <div className="col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-slate-800 rounded-md border border-slate-200 dark:border-slate-700">
      <div className="flex flex-col h-full p-5">
        ...
        <div className="grow mt-2">
          <Link className="inline-flex text-slate-800 dark:text-slate-100 hover:text-slate-900 dark:hover:text-white mb-1" to={props.link}>
            <h2 className="text-xl leading-snug font-semibold">{props.title}</h2>
          </Link>
          <div className="text-sm">{props.content}</div>
        </div>
        <footer className="mt-5">
          <div className="text-sm font-medium text-slate-500 mb-2">{props.dates.from} <span className="text-slate-400 dark:text-slate-600">-&gt;</span> {props.dates.to}</div>
          <div className="flex justify-between items-center">
            ...
            <div>
              <Link className="text-sm font-medium text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400" to={props.link}>View -&gt;</Link>
            </div>
          </div>
        </footer>
      </div>
