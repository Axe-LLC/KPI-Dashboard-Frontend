  ...
  return (
    ...
    >
      ...
      <div className="grow px-4 sm:px-6 md:px-5 py-4">
        ...
        {/* Messages box */}
        <div className="bg-white dark:bg-slate-800 rounded-md border border-slate-200 dark:border-slate-700 px-6 divide-y divide-slate-200 dark:divide-slate-700">
          {mails.map((mail) => {
            return (
              <Mail
                key={mail.id}
