...
import { STAFF_TYPE_DOCTOR } from '../../utils/Consts';

// Import utilities
import { tailwindConfig, hexToRGB } from '../../utils/Utils';

function DoctorSupplyChart({data, isRendering}) {
  ...
  useEffect(() => {
    ...
    for (var key in data) {
      labels.push(key);
      values.push(data[key][STAFF_TYPE_DOCTOR]);
      totalValue += data[key][STAFF_TYPE_DOCTOR];
    }
...
export default DoctorSupplyChart;
